        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    //EDIT THIS
                    var email = System.IO.File.ReadAllText(@"D:\daw\secret_store\email.txt");
                    var senderEmail = new MailAddress(email, "CinemaCool");
                    string password = System.IO.File.ReadAllText(@"D:\daw\secret_store\pass.txt");
